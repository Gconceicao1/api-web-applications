...
window.onload = function(evt) {
    ...
    btn.addEventListener("click", function() { Pessoa.calculateImcPessoa() });
}
...
var Pessoa = {
    ...
    calculateImcPessoa :function(){
        console.log("chamando função dentro do objeto   ")
        return calculateImc(Pessoa.height, Pessoa.weight)
    }
}